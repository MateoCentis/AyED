...
// Los algoritmos de generación estan tomados de make_random_tree y make_random_btree 
...
// función que recibe como argumento otra funcion o un functor y usa eso
// para generar datos aleatorios. Si no se le pasa nada, esta versión tiene
...
// btree (del cuyo tipo la función deduce qué datos generar), luego uno (para
// btree) o dos (para tree) enteros que controlan la forma y el tamanio del 
// arbol (alto y ancho), y opcionalmente una función o functor para generar
// las etiquetas.
//
// Hay además una función replace_duplicates que recibe un tree, y 
// opcionalmente una función generadora, y reempleza las etiquedas duplicadas
